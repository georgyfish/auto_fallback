...
if __name__ == "__main__":
    ...
    if 1000 == Pc.login():
        ...
        common.install_umd('b6ba94c99',Pc)
        # install_kmd('d8cb481ab',Pc)
        # umd_search_list = ['5efbca234', '4b3b7068f', 'fb15a8f46', '08cd254f3', 'b47553c08', 'de9c3e598']
        # kmd_search_list = ['d8b640314', '4ad2513cb', 'e60ecbddd', 'd8cb481ab', 'b7e13d6eb', '9d9792017', '9f34703f6', '2b9f60a46', 'b2892c59e', 'd0bc13bb0', 'e8110b2a3', 'a5a0caf42', 'a110ed8b8', 'e81d96b5d']
